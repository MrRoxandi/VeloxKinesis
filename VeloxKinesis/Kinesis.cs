...
public static class Kinesis
{
    ...
    public static class Keyboard
    {
        ...
        {
            new KinesisBuilder().AddKeyDown(keyCode).Send();
        }
        ...
        {
            new KinesisBuilder().AddKeyUp(keyCode).Send();
        }
        ...
        {
            new KinesisBuilder().AddKeyPress(keyCode).Send();
        }
        ...
        {
            new KinesisBuilder().AddText(text).Send();
        }
    }
    ...
    public static class Mouse
    {
        ...
        {
            new KinesisBuilder().AddMouseMove(dx, dy).Send();
        }
        ...
        {
            new KinesisBuilder().AddMouseMoveTo(x, y).Send();
        }
        ...
        {
            new KinesisBuilder().AddMouseButtonDown(button).Send();
        }
        ...
        {
            new KinesisBuilder().AddMouseButtonUp(button).Send();
        }
        ...
        {
            new KinesisBuilder().AddMouseClick(button).Send();
        }
        ...
        {
            new KinesisBuilder().AddMouseDoubleClick(button).Send();
        }
        ...
        public static void VerticalScroll(int scrollAmount)
        {
            new KinesisBuilder().AddMouseVerticalScroll(scrollAmount).Send();
        }
        ...
        public static void HorizontalScroll(int scrollAmount)
        {
            new KinesisBuilder().AddMouseHorizontalScroll(scrollAmount).Send();
        }
        ...
        {
            return NativeMethods.GetCursorPos(out var point) ? new Point(point.X, point.Y) 
