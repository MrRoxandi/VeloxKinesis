...
[Flags]
internal enum KeyboardEventF : uint
{
    ExtendedKey = 0x0001,
    KeyUp = 0x0002,
    Unicode = 0x0004,
...
/// <summary>
///     Defines virtual-key codes. The codes are hardware-independent and language-independent.
/// </summary>
public enum VirtualKeyCode : ushort
{
    ...
    /// <summary>
    ///     Used to pass Unicode characters as if they were keystrokes. The Packey key is the low word of a 32-bit Virtual Key
